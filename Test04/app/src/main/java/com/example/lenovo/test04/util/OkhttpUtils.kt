package com.example.lenovo.test04.util

import com.example.lenovo.test04.application.MyApplication
...
class OkhttpUtils {
    ...
    fun initOkGO() {
        ...
        builder.cookieJar(CookieJarImpl(SPCookieStore(MyApplication.context)))
...
//-------------------------------------------------------------------------------------//
        OkGo.getInstance().init(MyApplication.context)                       //必须调用初始化
